...
9. [部品購入チェックリスト](docs/checklists/procurement.md)
10. [Amazon購入候補リスト](docs/checklists/amazon-purchase-list.md)
11. [完成判定チェックリスト](docs/checklists/end-to-end.md)
12. [ESP-IDF導入メモ](docs/ESP-IDF導入.md)
...
GitHub Pagesから解析サーバーを起動するリンクを登録:
