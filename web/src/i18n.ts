...
export const messages: Record<Language, Messages> = {
  ja: {
    ...
    startLocalAnalyzer: "安全な起動手順を見る",
    downloadLocalAnalyzer: "解析ツールをダウンロード",
    localAnalyzerGuide: "設定手順を見る",
    retryLocalAnalyzer: "再確認",
    localAnalyzerOfflineHelp:
      "Windowsセキュリティ対策のため、WebページからPC内のPowerShellを自動起動しません。手順書を見ながらPC側で解析サーバーを起動してください。",
    localAnalyzerStartRequested:
      "安全な手動起動手順を開きました。PC側で解析サーバーを起動したら再確認してください。",
  ...
  en: {
    ...
    startLocalAnalyzer: "Open safe start guide",
    downloadLocalAnalyzer: "Download tools",
    localAnalyzerGuide: "Open setup guide",
    retryLocalAnalyzer: "Check again",
    localAnalyzerOfflineHelp:
      "For Windows Security safety, this web page does not auto-launch PowerShell on your PC. Start the analysis server manually from the setup guide.",
    localAnalyzerStartRequested:
      "Opened the safe manual start guide. Start the analyzer on this PC, then check again.",
